...
namespace nmGfx
{
	...
	void Renderer::DrawTexture(Texture *texture, const glm::mat4 &transform, const glm::vec4 &tint /*= glm::vec4(1.f)*/, int drawID /*= 0*/) {
		_data2d._shader.UniformMat4("uModel", transform);
		_data2d._shader.UniformVec4("uTint", tint);
